defmodule ExAIS.DecodeTest do
  ...
  describe "decode messages" do
    ...
    test "group" do
      {_, %{groups: groups, latest: _latest}} = ExAIS.Decoder.decode_message("\\p:orbcomm,g:1-2-8641949,s:terrestrial,c:1694768536*17\\!AIVDM,2,1,9,A,53m9Vi400000hULJ220TpLD8u8N10h5@uF22220l0p:3240Ht03lk3iRSlQ1,0*0A", %{groups: %{}, latest: DateTime.from_unix(0)})
  ...
  describe "decode nmea/1" do
    ...
    test "decode type 1" do
      {result, sentence} = ExAIS.Decoder.decode_nmea("!AIVDM,1,1,,B,13IbQQ000100lq`LD7J6Vi<n88AM,0*52")
      assert result == :ok
